...
function findById(id) {
    return db.query('SELECT id, name, description, image__c AS image,mailgappProductLink__c as productlink,productPage__c AS productPage, publishDate__c AS publishDate FROM salesforce.product2 WHERE id=$1', [id], true);
};
